...
def init():
    global sand  # 1 for sand 0 for no sand
    global goal_x  # x coordinate of where we want to reach
    global goal_y  # y coordinate of where we want to reach
    global first_update
...
class Car(Widget):
    ...
    sensor1_x = NumericProperty(0)  # decets what's in front of the car
    sensor1_y = NumericProperty(0)
    sensor1 = ReferenceListProperty(sensor1_x, sensor1_y)
    sensor2_x = NumericProperty(0)  # detects left of car
    sensor2_y = NumericProperty(0)
    sensor2 = ReferenceListProperty(sensor2_x, sensor2_y)
    sensor3_x = NumericProperty(0)  # detects right of car
